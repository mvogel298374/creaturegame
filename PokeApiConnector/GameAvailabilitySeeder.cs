...
public static class GameAvailabilitySeeder
{
    ...
    [
        13,
        14,
        15, // Weedle, Kakuna, Beedrill  (in both RB, not Yellow)
        23,
        24, // Ekans, Arbok               (Red only)
        26, // Raichu                     (can't evolve Pikachu in Yellow)
        27,
        28, // Sandshrew, Sandslash       (Blue only)
        37,
        38, // Vulpix, Ninetales          (Blue only)
        43,
        44,
        45, // Oddish, Gloom, Vileplume   (Red only)
        52,
        53, // Meowth, Persian            (Blue only)
        56,
        57, // Mankey, Primeape           (Red only)
        58,
        59, // Growlithe, Arcanine        (Red only)
        69,
        70,
        71, // Bellsprout line            (Blue only)
        109,
        110, // Koffing, Weezing           (in both RB, not Yellow)
    ...
    private static readonly Dictionary<(int id, string version), string> TypeOverrides = new()
    {
        ...
        [(143, "red")] = "Static",
        [(143, "blue")] = "Static",
        [(143, "yellow")] = "Static", // Snorlax
        [(144, "red")] = "Static",
        [(144, "blue")] = "Static",
        [(144, "yellow")] = "Static", // Articuno
        [(145, "red")] = "Static",
        [(145, "blue")] = "Static",
        [(145, "yellow")] = "Static", // Zapdos
        [(146, "red")] = "Static",
        [(146, "blue")] = "Static",
        [(146, "yellow")] = "Static", // Moltres
        [(150, "red")] = "Static",
        [(150, "blue")] = "Static",
        [(150, "yellow")] = "Static", // Mewtwo

        // --- Event only (never legitimately catchable in-game) ---
        [(151, "red")] = "Event",
        [(151, "blue")] = "Event",
        [(151, "yellow")] = "Event", // Mew

        // --- Gift (NPC gives directly or fossil revival) ---
        [(106, "red")] = "Gift",
        [(106, "blue")] = "Gift",
        [(106, "yellow")] = "Gift", // Hitmonlee
        [(107, "red")] = "Gift",
        [(107, "blue")] = "Gift",
        [(107, "yellow")] = "Gift", // Hitmonchan
        [(131, "red")] = "Gift",
        [(131, "blue")] = "Gift",
        [(131, "yellow")] = "Gift", // Lapras
        [(133, "red")] = "Gift",
        [(133, "blue")] = "Gift", // Eevee (Celadon Mansion)
        [(138, "red")] = "Gift",
        [(138, "blue")] = "Gift",
        [(138, "yellow")] = "Gift", // Omanyte (Helix Fossil)
        [(139, "red")] = "Gift",
        [(139, "blue")] = "Gift",
        [(139, "yellow")] = "Gift", // Omastar
        [(140, "red")] = "Gift",
        [(140, "blue")] = "Gift",
        [(140, "yellow")] = "Gift", // Kabuto (Dome Fossil)
        [(141, "red")] = "Gift",
        [(141, "blue")] = "Gift",
        [(141, "yellow")] = "Gift", // Kabutops
        [(142, "red")] = "Gift",
        [(142, "blue")] = "Gift",
        [(142, "yellow")] = "Gift", // Aerodactyl (Old Amber)

        // --- Game Corner prizes ---
        [(137, "red")] = "GameCorner",
        [(137, "blue")] = "GameCorner",
        [(137, "yellow")] = "GameCorner", // Porygon
        ...
        // --- NPC in-game trades ---
        [(83, "red")] = "Trade",
        [(83, "blue")] = "Trade", // Farfetch'd (trade Spearow; Wild in Yellow)
        [(108, "red")] = "Trade",
        [(108, "blue")] = "Trade",
        [(108, "yellow")] = "Trade", // Lickitung  (trade Slowbro)
        [(122, "red")] = "Trade",
        [(122, "blue")] = "Trade",
        [(122, "yellow")] = "Trade", // Mr. Mime   (trade Abra)
        [(124, "red")] = "Trade",
        [(124, "blue")] = "Trade", // Jynx       (trade Poliwhirl; not in Yellow)
    };
