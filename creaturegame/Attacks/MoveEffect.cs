...
public enum MoveEffect  { None, Haze, Flinch, Recharge, LeechSeed, Binding, TwoTurn, Metronome, Confuse, MultiHit, PayDay, Crash, Recoil, Rampage, Disable, Mist, Counter }
