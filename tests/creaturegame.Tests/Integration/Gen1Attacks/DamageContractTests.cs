...
public class DamageContractTests(MovesFixture moves) : Gen1MoveContract(moves)
{
    ...
    [InlineData("mega-punch")]
    [InlineData("pay-day")]
    [InlineData("fire-punch")]
    [InlineData("ice-punch")]
    [InlineData("thunder-punch")]
    [InlineData("scratch")]
    [InlineData("vice-grip")]
    [InlineData("cut")]
    [InlineData("gust")]
    [InlineData("wing-attack")]
    [InlineData("bind")]
    [InlineData("slam")]
    [InlineData("vine-whip")]
    [InlineData("stomp")]
    [InlineData("double-kick")]
    [InlineData("mega-kick")]
    [InlineData("jump-kick")]
    [InlineData("rolling-kick")]
    [InlineData("headbutt")]
    [InlineData("horn-attack")]
    [InlineData("fury-attack")]
    [InlineData("tackle")]
    [InlineData("body-slam")]
    [InlineData("wrap")]
    ...
    [InlineData("water-gun")]
    [InlineData("hydro-pump")]
    [InlineData("surf")]
    [InlineData("ice-beam")]
    [InlineData("blizzard")]
    [InlineData("psybeam")]
    ...
    [InlineData("hyper-beam")]
    [InlineData("peck")]
    [InlineData("drill-peck")]
    [InlineData("submission")]
    [InlineData("low-kick")]
    [InlineData("strength")]
    [InlineData("rock-throw")]
    [InlineData("earthquake")]
    [InlineData("fire-spin")]
    [InlineData("confusion")]
    [InlineData("psychic")]
    [InlineData("quick-attack")]
    [InlineData("rage")]
    [InlineData("egg-bomb")]
    [InlineData("smog")]
    [InlineData("sludge")]
    ...
    [InlineData("crabhammer")]
    [InlineData("hyper-fang")]
    [InlineData("rock-slide")]
