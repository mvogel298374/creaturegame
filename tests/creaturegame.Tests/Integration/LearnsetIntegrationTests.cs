...
public class LearnsetIntegrationTests : IDisposable
{
    ...
    private static void SeedBulbasaur(PokemonDbContext ctx)
    {
        ...
        ctx.Learnsets.AddRange(
            BulbasaurLearnset.Select(r => new PokemonLearnset
            {
                SpeciesId = 1,
                MoveId = r.MoveId,
                LearnLevel = r.Level,
    ...
    private static IReadOnlyDictionary<int, Attack> BulbasaurMoves() =>
        new[]
        {
            new Attack("tackle", "")
            {
            ...
            new Attack("leech-seed", "")
            {
                Id = 73,
                BaseDamage = 0,
                DamageType = DamageType.Grass,
            },
            new Attack("vine-whip", "")
            {
                Id = 22,
                BaseDamage = 45,
                DamageType = DamageType.Grass,
            },
            new Attack("poisonpowder", "")
            {
                Id = 77,
                BaseDamage = 0,
                DamageType = DamageType.Poison,
            },
            new Attack("razor-leaf", "")
            {
                Id = 75,
                BaseDamage = 55,
                DamageType = DamageType.Grass,
            ...
            new Attack("sleep-powder", "")
            {
                Id = 79,
                BaseDamage = 0,
                DamageType = DamageType.Grass,
            },
            new Attack("solar-beam", "")
            {
                Id = 76,
                BaseDamage = 120,
                DamageType = DamageType.Grass,
