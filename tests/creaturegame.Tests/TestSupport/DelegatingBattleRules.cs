...
public abstract class DelegatingBattleRules : IBattleRules
{
    ...
    public virtual int    GetSecondaryEffectChance(Attack m, SecondaryEffectKind e) => Gen1.GetSecondaryEffectChance(m, e);
    ...
    public virtual int    CalculateStruggleRecoil(Creature s, int d)         => Gen1.CalculateStruggleRecoil(s, d);
    ...
    public virtual double BadPoisonDamageFraction(int toxicCounter)          => Gen1.BadPoisonDamageFraction(toxicCounter);
    public virtual double GetStatMultiplier(int stage)                       => Gen1.GetStatMultiplier(stage);
    public virtual double GetAccuracyStageMultiplier(int stage)              => Gen1.GetAccuracyStageMultiplier(stage);
    public virtual int    GetHitThreshold(int acc, int accStage, int evaStage) => Gen1.GetHitThreshold(acc, accStage, evaStage);
